function Get-WEMGroupPolicyAssignment {
    <#
    .SYNOPSIS
        Retrieves Group Policy Object assignments from a WEM Configuration Set.
    .DESCRIPTION
        This function gets a list of all Group Policy Object assignments from a specified
        WEM Configuration Set (Site).
    .PARAMETER SiteId
        The ID of the WEM Configuration Set (Site) to query.
    .EXAMPLE
        PS C:\> Get-WEMGroupPolicyAssignment -SiteId 7

        Retrieves all Group Policy Object assignments for the Configuration Set with ID 7.
    .NOTES
        Version:        1.0
    ...
    try {
        ...
        $UriPath = "services/wem/groupPolicyAssignment?siteId=$($ResolvedSiteId)"

        $Result = Invoke-WemApiRequest -UriPath $UriPath -Method "GET" -Connection $Connection

        Write-Output ($Result | Expand-WEMResult)
    } catch {
        Write-Error "Failed to retrieve WEM Group Policy Assignments for Site ID '$($ResolvedSiteId)': $($_.Exception.Message)"
        return $null
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCOXC8wXM5ruiHh
# 66VhmGheimGa3S+YalecSl3Wbar+n6CCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IBLh9wRpEQ1lOrYcJZewLFG5UEOiw2Y4Ebomfs2xov6CMA0GCSqGSIb3DQEBAQUA
# BIIBgMINdfEsKu1yXb55PSaTQ3hNR45neT/fHG/S/8GrYtaBozvWVb+FEQpoQIHZ
# 04yitwGUnYgARjsNas5VoR4VcM+2I7cnZ1PVch9yi7TbQeEtymwgTDD5BtuJv7a5
# dIoq1wtePbgcXgBpOcZlOWKdaIrYlL5CsE4TkYpKesP5NoqjOvk50qW6wZ1q8iSv
# B2mTrISDihFgOcIFGglws6I3qK81UENS4L8+GME5KzgaGBDUSKY6J/SWL+ZhOVxT
# o23xExh1iJ5am9WTwHnf69aNJBA1f4kUlmzFlOzSFDgM3+91CbeVlD5nQJyw63w/
# 7wBZ74kiVmjeJqCum6RPEOlMaO0mPczfPdLFu9MjpZfu+zu/2358mUyQgM7dqcOJ
# vBimT23qCGrmBEoMvdXutE6GFOIPdhVYMgvH7bEIRi68H5k10WmFIFahLRyPvjrb
# nqf7fA7bGJats+QjSzD5v/UBqtSvMquP2uWtWTLx+kVLKeTJCx5+QFDxys61tOk0
# XxHjnaGCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCDCaFgO3OJeKaeu
# aNqgNB3gX1GxbmJoavNHcXXFRb1roQIGacZoEQKAGBMyMDI2MDQxNTE5NTgxNy4z
# MDZaMASAAgH0oIHppIHmMIHjMQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGlu
...
# AQkEMSIEIJYq8/V4hzNjIqmHBZvFbNx6D0LSR6FejPhZWxI9m8xEMIHdBgsqhkiG
...
# WkSPRedcsOuoQOHxTFAFxI2VSCznAIUwDQYJKoZIhvcNAQELBQAEggIACTU/w7H1
# dqbQG35q/Cyrb7jCf+UjIwHfZrADRoNIZJ3h44FTnSewMBygtC0n0C5bLhJ3QEeb
# FWh78+ZzDhP/w1zoZXMfUEIe4siHA9E9WlgtJZdpzH+KN3L08ty3e6TWHRH4zICC
# XyrGmjjhyNPwpnH6OmC4RJ19HQ/kstoaSsOE2NVoAxCj0A9ujrYP5bQzYD05y0ri
# ZSUitIBnCI5eVko560hlgRqXJM72Zv4LxazIiwWsj5a6ZzTSrU+RMDwXz9aWLaLT
# amAI7LrLYbSHtxAuqZFxOF6R+RSSlbLBSz8yhgvy/SUkfJCtyzIdLKlAHYNUvqtZ
# 1oz5mydWyLqLE7SJHzl1+lebLa6rBqadClj3KuHofl5nD7BkcTTRg4RLZT1sE0I/
# uJhPcg+4t6lRXBCsj1nrXPpu3IsIsEylCSbT5d4Rru4Rk1CCWcxZ3efBaA2IXUnb
# LltRNGBQTrwVvbEBsSerXvkBMp5SEL0YIL3QxF0NMKWqpW3ITwdLBQbQwrRmkrpX
# w7QEBj5ntfsTzhP1WwgtKVHyB0otwP8wFUlWZ0KPxswtZIVy109J2meZ3ZGMSbMe
# stY3qD+Nf55de0wqD+P5fdzXAVXEe1FZdg7yo1zuXKVH7U7aPQGfvUPtjGfSlZ3+
# nkxiDScpIqVKuSZRFloc/Yz0CDPZRCbml/w=
