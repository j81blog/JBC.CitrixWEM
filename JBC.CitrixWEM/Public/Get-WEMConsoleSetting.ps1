function Get-WEMConsoleSetting {
    <#
    .SYNOPSIS
        Retrieves the console settings for a WEM Configuration Set.
    .DESCRIPTION
        This function retrieves settings related to the WEM administration console for a specific
    ...
    .EXAMPLE
        PS C:\> Get-WEMConsoleSetting -SiteId 1

        Returns an object containing the console settings for the Configuration Set with ID 1.
    .NOTES
        Version:        1.0
    ...
    try {
        ...
        $UriPath = "services/wem/advancedSetting/consoleSettings?siteId=$($ResolvedSiteId)"
        ...
        Write-Error "Failed to retrieve WEM Console Settings for Site ID '$($ResolvedSiteId)': $($_.Exception.Message)"
        return $null
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDYuSDeX1cZDNeB
# WFoObwfQLpcPWSB7/RrOJVJAWY2mpKCCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IDHcva6zXtm+H26AwX9iUSQP/yF/QRPmf4RU3mkaEWsYMA0GCSqGSIb3DQEBAQUA
# BIIBgLLhV8tw0yPcP1ZgXth6k9suu65V34nHHIr5O2uuHLRK8Q1C21QYC8/eN7w3
# PsPiguGTb/O6sqmqFkF88ldoGJGyY20orjs3MbTz2ISOGVIhKJ23i/Mwy7S+yghU
# QIKtdbo4vgPHJQDb4yfEjpTnGNvzUEe8NXfcHMmFSESzRqH5oeal8GBIESD2zY+p
# wCI+JKamBHVXJqOpBI2RRsA+W6D34G8CQSsZnuCXOvgqv8PT8crbihW/y6DwwOOv
# ew++QIOMsdy7TaJRuJKeB8hrAkUKSnzxZ987Pk8NlURzgjG3dluq6SOMd40/kift
# PY5I19UVfPm0ZlkfqEvlFdqlCgGiwlas4mTGVPSBBKxLJSol7tyLA7mFaXQyNd+Y
# 5tDP10lczA8kAWPvYmFVuWxt6EwmMvvIPmwirT3BqZxT8LgkZRgK7inlo8V1jbfa
# wx+Tg3BI97QAdzhACZSzOFPZkBzf8pXvH6g19FkVKpid3LIHQUTBLdlei36GEL8Q
# 9jeV8aGCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCAJzLxdEFVShQuL
# pbqOA0f7NKWM+Q2bjIih8RgotvaHugIGacZcch0yGBMyMDI2MDQxNTE5NTgwMi4y
# OTFaMASAAgH0oIHppIHmMIHjMQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGlu
...
# AQkEMSIEIF2blY8U6H5ejqdlbvgsguKKaj2vPh3o1uZEonzzz11oMIHdBgsqhkiG
...
# IBH7Yg3Er3Da6Q80fPLQHn+iyLjKhfQwDQYJKoZIhvcNAQELBQAEggIAlvDTNCYh
# F03L1ePlVAQ4CgRYh78Ec7Jx8ajkJpG1EJPhxgke4ZXBRgiBod6rBI3FhKH5rmP7
# 4FwO7M5RUy8trrxYSccu4S8eepO+ffR4yq6K7YTtth246FOdQXkVN/V/WpYWWuX/
# zP5eZu1tB6CwYsPWeYjkO2R7u7sIWUr6EZUE1bvIMp5dq1KJljYHF/EykKFunGK4
# KGU/D0+9eVF5cM3fNlamOEYvHpjiBuc2VtAGs/vfLKAPoT5iBzq89j3stZvGpJo+
# l+/lKu61iltB6pP5rGtmhhIg7gQ8upIILw36dVS8LWswnMeKBQ2Q56pHCUG4UlsP
# D5nZvlDBd6Gy/v115iCYqr2h8w/LR7LpGs5HLlXMJKGkn4tmd+Ais/gUl1zEX+Jr
# lPNt+BsvorRaXgVy4JXSHyE09ULEhEaWr+CeSxi1w+bRDrvHjH78lEJCZgcWtc8p
# evPQ/eVfXT4K28QQQsPYBSYaYmh7xigxuYbHp2QtsdEgJlfbnIR3csvp0YFvphzS
# vTjEFPYfYfUY+CzhMGBtZm0nm/atK1NWeG+8EYVSZz1r4Cp39BhXP318RLfu0VAm
# 2O3UGGQ4dqvlYCBwF/rTgh/d/q0EiSU6Qtmh8v0jQxEoSSQQju46baH6I4kIWAI2
# zIYPdTcglVDehT63bxti11tk1DTcHHxwPuA=
