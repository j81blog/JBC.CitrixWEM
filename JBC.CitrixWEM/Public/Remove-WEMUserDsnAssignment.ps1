function Remove-WEMUserDsnAssignment {
    <#
    .SYNOPSIS
        Removes one or more WEM User DSN assignments.
    .DESCRIPTION
        This function removes one or more WEM User DSN assignments based on their unique ID.
        This is a destructive operation and should be used with caution.
    .PARAMETER Id
        The unique ID (or an array of IDs) of the User DSN assignment(s) to remove.
        This parameter accepts input from the pipeline by property name.
    .EXAMPLE
        PS C:\> Remove-WEMUserDsnAssignment -Id 72

        Removes the User DSN assignment with ID 72 after asking for confirmation.
    .EXAMPLE
        PS C:\> Get-WEMUserDsnAssignment -SiteId 1 | Where-Object { $_.resourceId -eq 5 } | Remove-WEMUserDsnAssignment -WhatIf

        Shows which assignments for User DSN ID 5 in Site 1 would be removed, without actually removing them.
    .NOTES
        Version:        1.0
    ...
    try {
        ...
        $TargetDescription = "User DSN Assignment(s) with ID(s): $($Id -join ', ')"
        ...
        Write-Error "Failed to remove WEM User DSN Assignment(s) with ID(s) '$($Id -join ', ')': $($_.Exception.Message)"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDJVCcp+Jo9YCGN
# aotC3uBAkq+Vy4biDLP6oRH1eNVXXqCCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IJFAxJlGcLBQ0gvon5s7vHvZDV+sMiF7hw51e0KfMo4YMA0GCSqGSIb3DQEBAQUA
# BIIBgFEenutdRB68zOrqPMo/Qyy0W6so8k5FBGiYQZ+WnqLznSkmWPFpzDcrgWp0
# 30Y+iy2v+lP28ftoGBs05Ofktf4zV/VCnfMxgdCtSA1uj0fXM9jDtmSzOKAZ9ntv
# VsZO/wBzyCs3P6HOIcztABSRQbOQC5IbhneCc3Jo2xp3bmHUMXyR/inbMReeb33c
# l+4jpyhlp1O9xP2v2oXIfm8dWc1AKp6bUnkwQ8mIiPFjmBolQalGTn+3QrMFIWYm
# FUoCNoJUWqTIz8jArDAGC3fJFeMT0Zr4AtDQjPx2LsTfu71I5ZyUJt1ILf5EX+eg
# lE6+P7SJCqHBhbHRP+p75O75JhGUOfRZlrs09epofrEjuO9+FhkRLxyXJbX6UoWU
# vGmV9ZcZgKRl60pU/zddDd/JNTwIg4XiY8vepN4Yqh+bwIf1kGPV+tw09vVfOpkj
# icxqrOTRN/pgxSPZ61makqf2RQ66ubqPIp5JrW4ohC4TNtySPtcvqybwScobrPN+
# j9K4C6GCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCAibd3apLMTeMFE
# q5NiTHo4K1Kd9Q6NLw/VSLKoxG7vCAIGacZoEQCzGBMyMDI2MDQxNTE5NDg0OS42
...
# AQkEMSIEIEASmmPjA6kyq+/hB6Dm8Pnk2TG/tdlgDIrNNLES+zRfMIHdBgsqhkiG
...
# WkSPRedcsOuoQOHxTFAFxI2VSCznAIUwDQYJKoZIhvcNAQELBQAEggIAS2vDBtuo
# zbLz+snJ1O/ROwNzaGQ6RoZ5ZXWUR+1KgI6QVMGG/DTephZo1c/XZwPq5WYGztwe
# cizL6sdwG1tJNVTLJgXmHowP07wWbHcLhdd+8SZRPKASTvZkgHW5Fn2XLNewLd4D
# JQYpZN6I3/DN5lPMVA0yv7e0T3cJDgmqlgBPicRAWb6dr27KxAEvhpiCQ7w1u6ZD
# cGSAp3D4QKPalxbBx3KaQVaAsfY/tj74NQ1ZlbqvfbRrM4dcMl09p6E1YR+zqUFl
# 547rKRc+7sw+Vqb3mKZyftj/QPjCcFoyu1H6lex4zXuFdzp141fXXj7HWlAJnZ96
# nYf35qUagmCf1tPruAzFbY9C6WscoNNIT59YN/fh5U3ntNmTTpb3t1v60coKvI6y
# yHzi2XPqrYb7zey+03W14YJnxIkYdbShh3lhVkbNGAXYtnTBW3UQ9/Af/gpiyvCw
# vQmU2dQpMzcJ+A25ar++Ez/lJ8L7Laou46oVnRHlZczMZf225VebOO8+GZO7pg2g
# 4RSzvZCmeQU8o+eS6Ya6+XaHhrmrkTvvM9BaapSgEVBLYiU7ORriBysWq/9uYE1z
# 34oDR2xrl+mu0X5o/ZMzjCV8ZJRjOfgQ7jzdkvYVOTk2q3DoedWy+ZsacVkmiZXR
# kuj/ADomO4xVx9XvMdCZTrSXNgzYc8KIFRQ=
