function Get-WEMRegistryEntryAssignment {
    <#
    .SYNOPSIS
        Retrieves WEM Registry Entry Assignments for a Configuration Set.
    .DESCRIPTION
        This function retrieves a list of all Registry Entry Assignments for a specified Configuration Set (Site).
        Assignments define which users or groups will receive the Registry Entry actions.
        Requires an active session established by Connect-WemApi.
    .PARAMETER SiteId
        The unique ID of the Configuration Set to retrieve Registry Entry Assignments from.
    .EXAMPLE
        PS C:\> # First, connect to the API
        PS C:\> Connect-WemApi -CustomerId "abcdef123" -UseSdkAuthentication

        PS C:\> # Retrieve all registry entry assignments for site 7
        PS C:\> Get-WEMRegistryEntryAssignment -SiteId 7

    .EXAMPLE
        PS C:\> # Get assignments and filter by a specific registry entry
        PS C:\> Get-WEMRegistryEntryAssignment -SiteId 7 | Where-Object { $_.RegistryEntryId -eq 123 }
    .NOTES
        Version:        1.0
    ...
    try {
        ...
        $UriPath = "services/wem/action/registryEntryAssignment?siteId=$ResolvedSiteId"

        $Result = Invoke-WemApiRequest -UriPath $UriPath -Method "GET" -Connection $Connection
        Write-Output ($Result | Expand-WEMResult)
    } catch {
        Write-Error "Failed to retrieve WEM Registry Entry Assignments: $($_.Exception.Message)"
        return $null
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAjWVfDuN9e763h
# NRCOeSSN3+xzdOBKx2IX3vGqL4d65aCCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# INzYEFdak50UuFDgVz2hby5qwty/4B6QIhwidv4LM7vIMA0GCSqGSIb3DQEBAQUA
# BIIBgMl3igvbIZzP4nR2FoiianyZG1FeMrF2vlyA3o/Dzj/n0ExrZHRMnuyqizv1
# su/hI/oaSTzls5LfnvVDzSjqRk6d2w4sLOxXIldX7b8MaHf3twU8108XVRWxns4g
# N0MC959waQ14xnntN1CUr95gg4XFu/2nGh46KEdK1Wj+uO6AGbR8AnSTe1dU8TZQ
# FFG+AzMfJtKv56TOx2iu7XvF0K2E9+ErQIl9OrgAASUYNuyZi8M2NVaDIiGUulRc
# nkyHEkS9ZqKoUPHZ/XGLNyqFwCRMeQ5lapGd6elopW/kH3vuPqT16m9q9RiUEMe+
# trscOGBhZcPv+pJm4smYpleE1WbJ8wVz+lvBXd4z/0F3b8QyC2WVv7xR4nxVrJ5F
# uiScYDlV9UhndbpmhfLzBAchbMC+otkegao7NXufgVQK1V8GpzcqK3pGeK7MpXxH
# TUwPDO2xs92+ClU9UOaYzdBCxl6156mSG9MCSL1O2kKZxHvLgxJiRBJWU6ODmZvU
# 2WvrX6GCFLEwghStBgorBgEEAYI3AwMBMYIUnTCCFJkGCSqGSIb3DQEHAqCCFIow
# ghSGAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFpBgsqhkiG9w0BCRABBKCCAVgEggFU
# MIIBUAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCCP9yhk5PNacprD
# NWczpfpd6ObjckubkByDXDFYeVNWJgIGacZiOPObGBIyMDI2MDQxNTE5NTgzNy4z
...
# CQQxIgQgM1IOnbw4+Z/qSm9fitEkQ09o+zSWl3Ki80yUeYsc/uMwgd0GCyqGSIb3
...
# WNcdmfN1t1ol2f34j1G1BTcqT4suWTANBgkqhkiG9w0BAQsFAASCAgB2tFSFVNXD
# fA4KtHfAgQhDad/nGdT6GcXGACc10mwUcbYIpG10dZeKNUwpLZAatpVlQJOX/QSx
# ZSKMwi7PuT7nSt1zc4XBQiu48LyQCQVvH/992X43geMmsD3PbrRNunYrsxMKZ+NB
# o9NjRr4pl3GTgkKtHPjOS3/UqzpyduFypl6NBHybl1SMJIXWxFtbkMs7LQ6XR0lV
# FD629j0wG0Y+3HLm5Ba3VGtm3/jnGj2dnTPK+4qMP3Iv+hDov+sED/YUPLleUw0y
# 7fb6GaYeCfshXqnkHFUJX82Pc6Lv/hG9LOd5a7aYc2jBbJ6KErgQS/q0sfM/IlXS
# 6DXHpUtgYmTtjxCt/Ft7EHWoJQSswwHc3MbuSHdQ8ffJ8MHpepfyufwl4RcI02ce
# NZWDhpCnI035vYkAkaAou+BmzOmIW1wvn9EplTNVpEuyS4odhCl8N3bOIKCQJEYf
# MXAEJET8OLZdVLqHaR1rQotWxYsAiwYZf4Yuy0520XRyL8smVTl2ijjzx11RzngH
# afkMGIF6K1WffZ65rvvNbcgcrad8Y+eCGFM6zAix6qSh4cJDeWxfezapYJBArWav
# KxGP7YL7jMDEpO4sSO3o/BNYpY7y5v2QKbaMPM4Hhbjx6jtZMgZPDfAAjZf5OgEm
# 51/HUAi6rn1x7Ss2C5v8n4oUuq8pDKJepQ==
