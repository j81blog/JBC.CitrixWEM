function Get-WEMFilterCondition {
    <#
    .SYNOPSIS
        Retrieves filter conditions from a WEM Configuration Set.
    .DESCRIPTION
        This function gets a list of all configured filter conditions from a specified WEM
    ...
    .EXAMPLE
        ...
        PS C:\> Get-WEMFilterCondition

        Retrieves all filter conditions from the active Configuration Set (ID 1).
    .NOTES
        Version:        1.0
    ...
    try {
        ...
        $UriPath = "services/wem/filterConditions?siteId=$($ResolvedSiteId)"

        $Result = Invoke-WemApiRequest -UriPath $UriPath -Method "GET" -Connection $Connection

        Write-Output ($Result | Expand-WEMResult)
    } catch {
        Write-Error "Failed to retrieve WEM Filter Conditions for Site ID '$($ResolvedSiteId)': $($_.Exception.Message)"
        return $null
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDgoMjWQAQ6nKRq
# b0/VwDce/vVa8AVcnb1cnoyLM/W2ZKCCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IHrVLYdThQix2NJJw82pjUDWJvsX49WZVXO6thkjyReMMA0GCSqGSIb3DQEBAQUA
# BIIBgHC1MLD3z00xDE7rB3QLk9O7OOG3jmh4KqybTqhlgZuPlDap0F8mqZ604TMu
# Iq8LG65m4xd0fX+VzSbQPuYA2rtzM8pUVpisy4Me7d49uUXX29Ysecjz5Y87IX+N
# zesdXNg0r1s1B6WoeZKjf61/PCxOhTbEqY31gugZi4t4ZTNan/1LZ89GYOCW2wm5
# VrRhpJh6GrzpVlrM+Edh7Z+gWBLXUDvvkNRZSoK+I2k59GXGWbNMaFgcWfC2Bkgc
# CQTU97gL1nE7yfEaOeKglM8jlMI0Ap1nbpQc94lX/0/+UbJTopMS8XTzRYxb9FTO
# ZATd4GUf/BFCKVwHyeoI0j4oAbatWU3GN/KTr526jqzwZnWD1lNL7XjmVbaWnsDV
# kbCd+loM0jcHpquoqO0xSgBm/9fJhsgqUgtEXvAPhAhBxM2rQtPYIWnaVXLZ2Zvl
# cYvPW/NfpzR8UtBruIgqXNj2kP1raw46TFA4ZfR/yXgyitY4wXKkI3FXBME30m+G
# eBDZuKGCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCAz4C2ofYmtRFad
# DrYb45z0f1pFFA4eszGeYUvNYLMosgIGacZcch1DGBMyMDI2MDQxNTE5NTgwOS45
# NTlaMASAAgH0oIHppIHmMIHjMQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGlu
...
# AQkEMSIEIKgwDbICt7NWeS7/wNsgfwaWZo8AtkHG99ySIEgv6C1kMIHdBgsqhkiG
...
# IBH7Yg3Er3Da6Q80fPLQHn+iyLjKhfQwDQYJKoZIhvcNAQELBQAEggIALlWNfnR7
# OKhyciFuH1Cc8uzxDoVXM1eN+m+U2r/cOh9pwZP0mb1lquOMfBU8ZwVIGDffiq2Q
# AP0j/HjGFOQYtM+32rWR0vzstJTNKqrIA5B4QLAEKN6/I62KtPbU6ArgeJ2DvVVC
# m02ZKldhdfoo3lxLEGeqmb7p9xwH9YfpAnNFBTEAZeplN7jFluWnRpIJo601R4X4
# KiB0HqDZpGrWgYVOCwUwevfavCxJBNwi+YROCfgp5qBt4SPEhTaRewx5HT7jRhXa
# 2jg6KuNsVd48Nt8SVf/4QedfMQc3ZGx8ij4IQhC4UpaydnvnvSY3xoRfEUYqBdSn
# WRqxEBuuE+vcNvqY1ENjHgv5RT14AopbptrX2EqAl28P0s4Thn4QDDlPh37hgbU9
# 9ouS+MlOtOmjV9kf7CqhWT49CqEOdImkQgwafjs7F483BQAvjyHsjcnVQM1hz4yh
# xzI1gaQWAn6VjF/80TwABz6xiw0PyEXTpQPc77vDvEzkMQkpUESmWyGscSBFaYoG
# ybaB9rWmHQfDYdyGAztdG/xIg5BOxJX9TmVdLh/5Qk+1Z7+QSpm8GB28hfB4U1J6
# XJtzlm+8trTpDi9kFxB66umYF6OX6gNwk0fcCTu/6aoz2PFsVw63Q/mp0w6i5PAm
# 72Wir5JBpcD5r17+W9D2Lq12rVrwws0n+p0=
