function Remove-WEMEnvironmentVariable {
    <#
    .SYNOPSIS
        Removes one or more WEM environment variable actions.
    .DESCRIPTION
        This function removes one or more WEM environment variable actions based on their unique ID.
        This is a destructive operation and should be used with caution.
    .PARAMETER Id
        The unique ID (or an array of IDs) of the environment variable action(s) to remove.
        This parameter accepts input from the pipeline by property name.
    .EXAMPLE
        PS C:\> Remove-WEMEnvironmentVariable -Id 32

        Removes the environment variable action with ID 32 after asking for confirmation.
    .EXAMPLE
        PS C:\> Get-WEMEnvironmentVariable -SiteId 1 | Where-Object { $_.Name -like "*Legacy*" } | Remove-WEMEnvironmentVariable -WhatIf

        Shows which environment variable actions containing "Legacy" in their name would be removed, without actually removing them.
    .NOTES
        Version:        1.0
    ...
    try {
        ...
        $TargetDescription = "Environment Variable Action(s) with ID(s): $($Id -join ', ')"
        ...
        Write-Error "Failed to remove WEM Environment Variable Action(s) with ID(s) '$($Id -join ', ')': $($_.Exception.Message)"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBGPmGQgblAT4U8
# 6yaRqjqklNun5ASygi83PDSMmlvbSaCCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IP9MIgUS/etPnAlPY8mxERIqOlaWZs3CVstSKleYDoHLMA0GCSqGSIb3DQEBAQUA
# BIIBgIKKcYTEOWrgkZqyQ5ukaOg37FFgv1MptdeWTI5Z92GBIE/EBZYQz8vJ8l+6
# Zyh0aiDLyiMa47/r0qWa9To8pYyETHfJ2iUa2AhWAJljFCiU9Wk9Jmfdr/qOK54g
# qVNyt500YJn8z6xA0ujLl6p+Z4jZ8ZyJLpxbVRHl1i5Ae97p1j+Ie+5jbXc1+aH6
# fMzqBqqzPVm1GIBmnM3dmqrxH6AWTSKPHSSDRNUpcbd8TWbouaGKTdsUoVj1P+n+
# mHq037y6KKdT/zD6MUbO/ByxmE+xpqeVPIf1HSsI7DRWRVL1EC3w4rqs8IZun14y
# HyTbDsQ0uDmxkWcuHwI1oLwf6PGSUucFhbAA8tsiQiCukAP64fhyI3RyQy/9LR69
# Z4oU+Z1DccLDUt6RxXIC6F49FU0KoAL0QlDvZNGaZyrvPTqBfdeXX4J3ClLpWWb8
# jtwT1FpJzxDLGX6LOIfFrNoFv8ra1bD+no9TueMzDomBY/aw4/Ju3hVTxFjoaZQH
# aR21q6GCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCCDAHLc7lPymyds
# ncSu9Z3p8CThZRWiJdV/umxnpSCK8QIGacZuNOveGBMyMDI2MDQxNTE5NDgyMy44
...
# AQkEMSIEIMX3BuZy8NDY4Zhtk8H0hQ/rW+E/m6C1tAvKK9lLkYfKMIHdBgsqhkiG
...
# 7uWUtl7jNMn9x8zfnOBTl8hH91XjZiAwDQYJKoZIhvcNAQELBQAEggIAahSo8Ips
# KoR3ZsGDjuAEmwgMx3YibPJ+j7AS9iMRPa88unqPHKygzUjOcgqBVSff2Q4xyav1
# DGpRn7+i6dDGt9pj4GeLws0Z0jeyEEQ6QrTUBpc7RqyTwiw/8XFxTUKdIcWf5H5g
# aMJ4KFJlOXO2LwmbVuf2Jf7WnwRbxjbUKu99dISf0qRBwU+YkjqaHet4ihNSkPCO
# 4PGQ0i70x/08J8wpFR9XzdCvCld1Xc1Bzl1Ei1OFt5r5qOi7DbNfTcNNwbC52UXD
# wI5YpdC+mPkqi9hx9Bzk+C3IJBLqPvLNeIIN52U/9+AxA0Y9w8LJs9ejsuEJbdej
# +WR84icLa4jA4lQzLx5RkzaueDbeB5WkEjjuIAkjf2wBwjxQOXEE/S4KmC1JSVwX
# mdKeqmVF6Pz4SHHd9Z730UMcHXVoMMxkCPcbmBfgI1Zh/0cvz3GDAb0h017fbZrt
# 2nIT3z05910OCu3yD/EaiCGSlsxxkW1LRX8XNr/7dpwBhXtG6KDQ5IrhY0zeCZOp
# xe3W4iFa++oL7XNyLhmF0pPNBGLMCAgurtizFmpkU6fYZExDJYIsK+I30ZaCgB+p
# l+WZ+j558i2MCfxvvZmNpYbFnEeKEJOW4LJ7+H0h//E5UXmtXasCVDC8EXwZswnx
# +piI/rF4I9pdRbVIVLS1UFqW0ywcY5HdT6g=
