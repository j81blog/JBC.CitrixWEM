function Remove-WEMGroupPolicyObject {
    <#
    .SYNOPSIS
        Removes one or more WEM Group Policy Objects.
    .DESCRIPTION
        This function removes one or more WEM Group Policy Objects based on their unique ID.
        This is a destructive operation and should be used with caution.
    .PARAMETER Id
        The unique ID (or an array of IDs) of the Group Policy Object(s) to remove.
        This parameter accepts input from the pipeline by property name.
    .EXAMPLE
        PS C:\> Remove-WEMGroupPolicyObject -Id 7

        Removes the Group Policy Object with ID 7 after asking for confirmation.
    .EXAMPLE
        PS C:\> Get-WEMGroupPolicyObject | Where-Object { $_.Name -like "*Test*" } | Remove-WEMGroupPolicyObject -WhatIf

        Shows which Group Policy Objects containing "Test" in their name would be removed, without actually removing them.
    .NOTES
        Version:        1.0
    ...
    try {
        ...
        $TargetDescription = "Group Policy Object(s) with ID(s): $($Id -join ', ')"
        ...
        Write-Error "Failed to remove WEM Group Policy Object(s) with ID(s) '$($Id -join ', ')': $($_.Exception.Message)"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCaQXCIV5et4Ngc
# XJadmMAfREuYiFkXU1cWy+Yi3XHm1KCCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IDui/8N3bq+EOtjxM8OEyP1GfOanhKbG/Ku6nqG1PMXEMA0GCSqGSIb3DQEBAQUA
# BIIBgMOipcW7WU0W1CkID4ZOYvTEIVV3NHjiyFMu2gyJXMs8KdHdKZK8bYjyMPZj
# id7j5w4KM/JCb1oIeyRpYaXmhlauhQU84Q7Evv0lSUq0dPvDhU3PVxDGh9YNbTaF
# OWDGuog4QzqZ3BF4YnlQaSD4snvISJQRIk3oznIMn77nyP+8Gk2Z2ECctz4kx8Th
# eMOkG2Zx429SJ0u0aY+uxRaGdBhXQCy7dQHRBN2heFFoWimAPp6qHrq1KJ8K8ayl
# hZICY/hWIkcGukEr4oqvSTc0lA38ucBPHIQtw+niY5UWjKqyEUPAh68hbxwDphbu
# Pb75quIwI/YwVnokkAmPEmkQf6LaWD/I9an/2T9pP5VvV8vjk8Rfb3dRuBnf5xlR
# G80uGHkkdaZlce/+fwGgebC9IpM5S4OibxJhHaMsg47aaT2eq0Jr4zIvzwrQyd3x
# K+idgRpwS0wiLO7m2tjpU0mVS5NEvVsDRuDDyAc3e5LUTr3Cfzed0W7kzLizz5Qm
# eC6/pqGCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCBZa24aFi+dNPw6
# ICOtw5ZCVwlUg2913TthNw2Q9AVSLAIGacZcch1nGBMyMDI2MDQxNTE5NTkzNy4y
...
# AQkEMSIEIPg+jqUFYcyZNZpmENLUavfYXF125SH+FVeg/InBCDSkMIHdBgsqhkiG
...
# IBH7Yg3Er3Da6Q80fPLQHn+iyLjKhfQwDQYJKoZIhvcNAQELBQAEggIAoUBeHXcs
# kZVGHoxy72fHwImJdF4jSQxcbp1wy9M5LA1Gh4BHLDcNYhLLEFmgDjZyer0zV7NE
# v4un74O6Lw+p799OWFXffP5ObOROZtCUB+KpGZQyVd9zsNsHyUCb06byED+mzbOc
# 9N/YLnsY2cJihqJkD4SQT9qc+5J9KhWTPNnvTYqbjLB4GJCUUkgCBgGevVh+d9Up
# Cbak1GfYimPuXplfTllJR6euZRRAv/svzHDKzDz+Dkz6c/x6vx9YR7UuO/sfvJPH
# djX957SOvkPMBnGdUZBO5OQ/ha0uGTq2x67O7mAr+CFawAYCiaBaEkq35rT//iDG
# OP5215I1L8ouH3A4crWpU+lkhIkaEqR4XJ/G5MhPgwhpiQIUClbnfbtHuhaufo+D
# ftOiO+AMQvCJgU9h4yCZgNwc+x7gWyDTD/mGkk/KR5yQffOLuqMYRQA8IsjewiOn
# fJadDpE3yKuqPNIvn7I6ijiuDQ6d03t5mkest/s7OAC2k9XIBjzSAXif04Mb4xJM
# ZGdfll4wGvtHyaShB0+odgGzDnkikhZyqfiu0FKqsoqGZFbizyakSM1jZ0QFdqS0
# aAPkFtUtoSwvCo3P4i7YkMDRVnB+uAKoOccoMsT+o0Meqy6WMYXy/viARi94K6ki
# bNTLMlkg5q7N8N8ifLL9Zto3fdpHJo1vhII=
