function Remove-WEMEnvironmentVariableAssignment {
    <#
    .SYNOPSIS
        Removes one or more WEM environment variable assignments.
    .DESCRIPTION
        This function removes one or more WEM environment variable assignments based on their unique ID.
        This is a destructive operation and should be used with caution.
    .PARAMETER Id
        The unique ID (or an array of IDs) of the environment variable assignment(s) to remove.
        This parameter accepts input from the pipeline by property name.
    .EXAMPLE
        PS C:\> Remove-WEMEnvironmentVariableAssignment -Id 72

        Removes the environment variable assignment with ID 72 after asking for confirmation.
    .EXAMPLE
        PS C:\> Get-WEMEnvironmentVariableAssignment -SiteId 1 | Where-Object { $_.resourceId -eq 5 } | Remove-WEMEnvironmentVariableAssignment -WhatIf

        Shows which assignments for the environment variable with resource ID 5 in Site 1 would be removed, without actually removing them.
    .NOTES
        Version:        1.0
    ...
    try {
        ...
        $TargetDescription = "Environment Variable Assignment(s) with ID(s): $($Id -join ', ')"
        ...
        Write-Error "Failed to remove WEM Environment Variable Assignment(s) with ID(s) '$($Id -join ', ')': $($_.Exception.Message)"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDOXD2drt4c8ece
# 5xPV0kPEhe0jatjnE4XkwbtjSFIWy6CCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IAg7S4fgQ462eXwE+pXqCaA1Qql9HtmLa4K9+Uvd7/iUMA0GCSqGSIb3DQEBAQUA
# BIIBgMtPjr2hv9y+VxHKVfAx0AJa+eYP6CIbvEX78M++L4M0aovzulNrlp4yKk/O
# N5zT+Bji+sObLzFs6EfB/1GUFRqSDp5rVBY60pYmvLU3bxmetnVthFMUgpFAwLy3
# qqLYuSAVekimqJSTjXdJqW1ucxI21KAzaZOuprkNaLmkfAz0iKsHkqGibyJ2AEyM
# zH2m2Ikd0kjffsRgBdYIVXydf8B7gMOgDOYyDyira0VlhN0bTM81uZsBfqTRgD5H
# h2CeeoHff3RFhMThYFEeXxJ2WFXCB8Lt0ZvI8+laPEePIlR4QsSIfpkJHGe1Ax06
# BmYT0ZPOCV/c1B6ythEOFuWBCo/uGkP3rahOlSOG6CuLCe9XafDU3HKMtyp+h4qT
# bWD+ug85oq/dmxPCwGMVm8mTdpOHvNXZ/4IkQUP3zTGUANqin1XlrIzVIIGVqo/H
# QoHPkviHgasknEFOvdqH6xmGU432lVvjQ+GQ8oILnkKWYNjJ4N1rDxExkc6X5bdD
# DwQ0yKGCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCAmDBs6k/5gBTQz
# aicEho/FSmb+rceaUlXz7c0WPsaLnwIGacZcchr1GBMyMDI2MDQxNTE5NDgyNi4y
...
# AQkEMSIEIEKRAREDKZYBqCOffvwi5JgERN+5sULI2hMxkEjKI5J5MIHdBgsqhkiG
...
# IBH7Yg3Er3Da6Q80fPLQHn+iyLjKhfQwDQYJKoZIhvcNAQELBQAEggIAfOqOD5KH
# rwUr8o8U553Gv9FbKz+pQtThhhMqh1CyDJUhxkE9f5VPxaWGHjdGVsOiTH4yeZTQ
# qCXowEVxpw+05I8dXHwJ5odl39bLFIh+aPCrYuRYEg3m2rfl0gLLXRGje8bqe7Gy
# hpntSq5gcAF0oGnE7vXruhxHohqpm+jNqKG5+tj3vE6/Ay5enYirq03qcgpe4j5o
# UjXwhrqqDkVZyTZyRJ7TAD7CSAe92XTNKpPlU/RmqFrT+Shtzt9xvIsQ+P+CfFAh
# WpD1FrUIfttkHRxhbmS3S6TfVGtW9a6j3Mk12oFkJk1XbiowBRPfencJZUCjP1t4
# ukqbMYt1NDGe9iBmGUNfzXZWqldildiXT4RU02NQ9t7hm0w4DbTXyb9Ye5VbfGDZ
# P9nBZAOCPpKrWesh+BvxZT8gAJu5rpSxpZf5t7IllH4vVFRSNwHg7rKg0/qZyRNK
# sVVT+KyuHiFRnl7ADo0af3kH/M5RbTs+wVkNKFLNvAQGZJYuQHp7lutrBsDEBRxj
# 5x0j2dYLCZnnpZbCZRpyFfWd2zP4dffojvedTdz46qme/xDokGMJES4h8HLW2mrf
# qzHVU69Xnyct+aAbSZGdOlLl0wvxoETTWTzDfVnuyPqq3z5OWOh1UUpEfMvL26m7
# UMEIRTg8Uj/37TH5Lgil2wz0ImHSzJS61VE=
