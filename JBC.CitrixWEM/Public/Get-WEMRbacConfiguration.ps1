function Get-WEMRbacConfiguration {
    <#
    .SYNOPSIS
        Retrieves WEM RBAC Configurations (Cloud only).
    .DESCRIPTION
        This function retrieves a list of all RBAC (Role-Based Access Control) Configurations
        for the current customer. RBAC Configurations define the role assignments and permissions
        for administrators in WEM.
    ...
    .EXAMPLE
        ...
        PS C:\> # Retrieve all RBAC configurations
        PS C:\> Get-WEMRbacConfiguration

    .EXAMPLE
        PS C:\> # Get RBAC configurations and filter by a specific scope
        PS C:\> Get-WEMRbacConfiguration | Where-Object { $_.ScopeUid -eq "4e5c7352-120f-4c0a-8728-32b75c3826aa" }
    .NOTES
        Version:        1.0
    ...
    try {
        ...
        $UriPath = "services/wem/rbac/configurations"

        $Result = Invoke-WemApiRequest -UriPath $UriPath -Method "GET" -Connection $Connection
        Write-Output ($Result | Expand-WEMResult)
    } catch {
        Write-Error "Failed to retrieve WEM RBAC Configurations: $($_.Exception.Message)"
        return $null
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDLV0pXKs9bpVg9
# LEh4cxtl1ki2XruHD/P2sOL6jZRpCKCCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# II0fkyIjqSfcac2tJXmCKzr4VrKj02fRm3ocJMusRzJrMA0GCSqGSIb3DQEBAQUA
# BIIBgNc0BeLFoIn7ekr2emsLysDievO2BgGhM9AtJofWxVhEQuct4LLKRJ1NPKsE
# LL44qak/AEyhGSTNGYSuf1sy2Rd0JWfpU9XeaNhH3qaVDA+vOdWVRviaQVHZgSok
# uJaJwnURqEtVrJyQCoM/k4iCrw6Cx31ruBxfPRvDHoHkWiKSnCFMwtZm03Nd0PIo
# 8zlP34sIps88g/X6T1aa4iQdQOHQ/TBRxS1mp7d+3gxNQ/N1as6vX+B6XaAPQ810
# 3uef4QCfqFNN5l9WPCr+/+so5QyvIqYW2tfgOD9+DY+la+CeCma7yRfjw7TCn1QM
# nh8HbRCg8vsJ9IhsdkSuF572YsGz7o3ui693P+WYKivJsDc3yXVe8Pla8glKM9Tk
# bUqLQW947zcBt/SoLBJ9SflqOQQc4z3R6R4FOabDTD2367IIXzqXDPRUtb+Ikm3k
# fUUFJwkho6v83mbPYJGNZoBUdd8q+014scvAxi5EvALPlG5AzOKZe0OK9U4/yBP3
# ZssbiqGCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCAGqNMZwbNwGNRM
# hQOFu1rQxQuiE8to12JYrs3CtRwNhwIGacZoEQKMGBMyMDI2MDQxNTE5NTgzMi4y
...
# AQkEMSIEIDUhCXAOfNe4MpnZP3JaWSzhGZGNpx21NjQ0I5rFXpJkMIHdBgsqhkiG
...
# WkSPRedcsOuoQOHxTFAFxI2VSCznAIUwDQYJKoZIhvcNAQELBQAEggIAhJRkGGwo
# rr82RyLJLLFmfJK7XYSZ1KXijNwVz3buhP/q0UGumoE1VEaX3KxScbcUMfFkfgcU
# 7pfBS/vQesGg/eTa2yIikSMowM4yAWmYj1vGJbw7qmNf0DMD9os9gnLV3qW5+5/F
# zvNGBJuI2jcro6/FBXjBIeL0uIio4cD4y6GIzYTW4Q7DPg/eNVhFjsjq+2kyihtF
# r9WH8OO1cbiPARaHc/R5j4VR3v0sQ4P5VrT6Op8muihF1NWjq8BFReDXAziZGJp7
# aWPtrN/6j4ZPikhIn6bw9RYB7HISKtrk9HF2VFH/RaXGVGftXwdiOuyrDHVGBtgl
# AI1RJo/kfU3G2WaghXPpm3y70bcCazMeZHwHrIw979kQqa1lgeLNB7soJKtLElKl
# Lc4XKVnHqfR/3vRMZsgt9JBILNi+tb17bnFxqzfQLwfsi1rzIxhl8r/ELHC6dlLr
# JEf7fp0J9P5LrZuycJWRxKEzaGhmHFyO6znfb2unVfAF4eWYgrT47jcutOj5kJVm
# OIZiIyonjNsv/jdu4y0Y1GeEtFGctwnZDL/PDclDU99DvzKPnVW6UfmPVqfNZ9tC
# rwkxSIt6mYRWYdMlWvsbZJJ+qGhavKSWiAewAZRAkOLfb4iGtSMzTrh9z1m5fm/A
# 8NdhzFAkT9bbdeOy9aZfy362x2XPJzEZqA4=
