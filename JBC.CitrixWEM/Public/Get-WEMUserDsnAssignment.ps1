function Get-WEMUserDsnAssignment {
    <#
    .SYNOPSIS
        Retrieves User DSN assignments from a WEM Configuration Set.
    .DESCRIPTION
        This function gets a list of all User DSN assignments from a specified WEM
        Configuration Set (Site).
    .PARAMETER SiteId
        The ID of the WEM Configuration Set (Site) to query.
    .EXAMPLE
        PS C:\> Get-WEMUserDsnAssignment -SiteId 1

        Retrieves all User DSN assignments for the Configuration Set with ID 1.
    .EXAMPLE
        PS C:\> Get-WEMUserDsnAssignment

        Retrieves all User DSN assignments for the active Configuration Set.
    .NOTES
        Version:        1.0
    ...
    try {
        ...
        $UriPath = "services/wem/action/userDsnAssignment?siteId=$($ResolvedSiteId)"

        $Result = Invoke-WemApiRequest -UriPath $UriPath -Method "GET" -Connection $Connection

        Write-Output ($Result | Expand-WEMResult)
    } catch {
        Write-Error "Failed to retrieve WEM User DSN Assignments for Site ID '$($ResolvedSiteId)': $($_.Exception.Message)"
        return $null
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDcX10p57ZhNRLT
# HxBewRb8XdLGfpEq5fFp7godh7zJxaCCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IPMzCTggSzP1bm6cz85rP2CnYuMRlTQNv2YO7Gp+q9dXMA0GCSqGSIb3DQEBAQUA
# BIIBgFDlN5UhwGlEQrDnt3Gx+IrW4IMIHHEtEMjJEtj7ii8J7K9m1Hk5LYHTR90z
# Laaaf0nj9EgjEzMVreJplad/x3RAN8A8oLCTY1V1OQgmki4mf4gPWXasiklVDJgg
# 2i6bbmV0+t23KlgsMVh1AnihPTEB0Vl3Hy4Xe+GQNttPXlo+54NrRKrSGTZex2B8
# lXaAm69uH19q0FpVSd1Ecnlb78bJUqu/D96q6Lj0UC7gQwWaFuuF052YrGG3skfa
# STlKWc3KunG69rP0b6ZorzkMguG/seEtJzMH7YBtkBh7bjyv05O/tUbG3Wk1Yl7l
# HOxNGK7qlQr+sK9zGNNLfB/Rs+1f7oobMgIZ/x7/m2NEzy5iAzj9QGKqhVcB2/Zf
# y4289TrCNwlv0LfFec2OMPUeaD9mdhdDbHnOdNEA0y7rS3QiXlneroeIlhG4c5Ex
# 8oUdHZNTiedkd/e09gAi7YoUDhrZDN6L/pinoF/W9zYTKF2TU0GSX+Q5EtyVzLaP
# Y1mNAKGCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCBv4mtC5y2SHsCO
# xBrSySiCHDnOPi71nP05JpAsc8evNQIGacZoEQA4GBMyMDI2MDQxNTE5NDY1My42
# MTFaMASAAgH0oIHppIHmMIHjMQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGlu
...
# AQkEMSIEIGJ0WYJI43PJ2pd1PiQz8chsCIboBtw4GRc/Z68B9iS3MIHdBgsqhkiG
...
# WkSPRedcsOuoQOHxTFAFxI2VSCznAIUwDQYJKoZIhvcNAQELBQAEggIAF2zy/OVJ
# UvsCCe/59YRpPcZKemvfqHUSzoqiT+QWgsQTf0A4PKd+5x4VsYQhgtslnlewsY1R
# vg2DrldV5SvHwLKoNP+yTFHJSQwgOOucEoUzqh2dPtNBozLDvb+EKAtq13S1jIIh
# H8lBTAmYLP66AtZ1ZyVVjfGv38vE40aLuBJUpbNeZnUWxM/GkIo4RlAjV4EHjkiZ
# /7Y1nabhzXsgaFgebQZZ1/PKVa4j5Ga5CGiXxvXwL7alaZ+lnf+rp2MGWDVW5Q94
# NgIyGq1YIQStiKtn0tgzio+WRf4WFDssmP+ZSQOjN7h0679BGK16KHAj96EwGTRS
# Uqcq2PQ88XmWslT3Lb9EbL4ZWea4R0recS9QrzM0D2kh0KVBce4yJZwJ3YRtZqjg
# UvlielmPdc8ggvnBeoSHaPS4xXIGqrtqwvqSTKGRsifwVVqFXj1LJfOL00YSc2u7
# PHS3XUy6sI3bYTOM80L5g17TSkYE3O/RQZWV+SouStniDZu1r45STSy/9fwTBIwx
# ajSrR5GW/NkAZ/JSOAkvbWeVMo0vpHIviXMEWvqM9dgaDBw0PzHCBWiCwviWDgy0
# ROCI9sqGMw6sgJNn7yGdEk/CZuqAClVd5QqtVKgPIaqzNpBKpRG+6K32nvcJL9hb
# d2GWKJmeRekhcuPu3E9JiFjoCRR+uIK8rSw=
