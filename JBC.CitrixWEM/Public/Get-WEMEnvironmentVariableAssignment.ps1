function Get-WEMEnvironmentVariableAssignment {
    <#
    .SYNOPSIS
        Retrieves environment variable assignments from a WEM Configuration Set.
    .DESCRIPTION
        This function gets a list of all environment variable assignments from a specified WEM
        Configuration Set (Site).
    .PARAMETER SiteId
        The ID of the WEM Configuration Set (Site) to query.
    .EXAMPLE
        PS C:\> Get-WEMEnvironmentVariableAssignment -SiteId 1

        Retrieves all environment variable assignments for the Configuration Set with ID 1.
    .NOTES
        Version:        1.0
    ...
    try {
        ...
        $UriPath = "services/wem/action/environmentVariableAssignment?siteId=$($ResolvedSiteId)"

        $Result = Invoke-WemApiRequest -UriPath $UriPath -Method "GET" -Connection $Connection

        Write-Output ($Result | Expand-WEMResult)
    } catch {
        Write-Error "Failed to retrieve WEM Environment Variable Assignments for Site ID '$($ResolvedSiteId)': $($_.Exception.Message)"
        return $null
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDAOeMdwKgqW4w3
# Bk/QBXxxGeKnaS3085q3HKSAkADsK6CCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IAKWvbTqkj13h+y/m72t6TnRc/tCZu74CIurAXVviq3yMA0GCSqGSIb3DQEBAQUA
# BIIBgBx6hv9eknSaoSE39DAGF+QRBTgEuuD607HnRJuz0bC3yjuSbs7mD43SXUbq
# G2sjH+0LqYA6k765PgAEK/zHL0FmvWBGXyxfg7zxYR1M890KVxC51VXjYy4EYTDi
# acDt+00b7eM6PC99KGim8fDtlG1XGg+A4CFNTEmC6jwJR7hVTUSyZIFT3ASFhopj
# hOkv6BzW90cjRJzkIzXURxlkxbZF1ynM67AcjaFJQLraBsrobHYyFC0Cr1GL3CxC
# oNKqsf4SMB5qjnDvO3ttwBeXQ51K4OEMIB4OgFq1wgR1zCb8kPXjMNnTYJz1+at7
# Ccsz81X8ykfBNJwQ9aOCf7Fsfr87rV3kihvFubgc7yMmMulPNjxxlahhiIJ2IUJR
# pVu+n7S+deLaDslnX0jB9Mr7f2X+yciY0rDp1AZuSpmniJJd6buttzWhUlQxpK27
# zL60lAZEYBigSmcbAtje5voJ48iW8TiOxBIm9ttY2Tv8ppg9rRat121tFfziPKCj
# 2ckJ2aGCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCAqqgOR/6gBjSXK
# rAhKIk52pvxO7zVtYkH4wC8RR9Dv5gIGacZcchqiGBMyMDI2MDQxNTE5NDYwMC43
...
# AQkEMSIEICh3PvP5UX8rIybNtQUWDGwj1AHZm/OUybW3Qby5zjsAMIHdBgsqhkiG
...
# IBH7Yg3Er3Da6Q80fPLQHn+iyLjKhfQwDQYJKoZIhvcNAQELBQAEggIADSB4yZ4N
# /Ip8W7V4aKBIV8YEmsQVWuooP49FUVTfDPavma7WD4KrXN8xjEtH18hDBUQQRIza
# 3k67FrzPUyHGjZenF4YmP71gUvRrWaTHXxvczDDx2AcgN/59rKzYd43sd+jXz48M
# LlOgMr81wULRZo8rLiGC9ufsBE6LNDGPfiSaSmM92bUn+G5FDeBmK5AluoLK+ZpL
# ppnm5FWZL6E8X/fntFi8a4B0gNg9xzeh2K9sbD+v2yQGgrqv7uHMJQ7pJ4yPUHnd
# SVnthzpLbR2WnkRcz6qD5U1g2pbOh53ESHDnU3fBh5AezliRj69Y7DvSdR5yyYYR
# 3FB+9JgQoEm3+Fm+VWwO+Do/w70QfOzYJE1woR0gSEmStR26TktRderoe8RwExUl
# dGeo+iKCjSJ6iEkcF7kSWs5hv/eCn6VE/qqQHcj3pxVEavNk3RC5HRI5+xJ6iOfm
# X4FaN4MMM8ktARvPiT1kUZ7+20xa0Z7zjmtyK+R3NLsl9gTFxetmoEZTV3nID9+u
# zHaPIfeA74oKtjOyGf0JJHuwNhZHICl0cmndfpUat167xkVOeMwI7dpDGnV7FK1Q
# fHCugtttph9mdpCH3nXfh0SJFCvIZyToGpcnF1SX+KU2gO+pvr2xC4/tDmPzhodT
# P4HH2KX2LCWbtyOkMWdfl/mnhxPO+lFbMu4=
