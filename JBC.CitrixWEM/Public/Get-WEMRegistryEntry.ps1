function Get-WEMRegistryEntry {
    <#
    .SYNOPSIS
        Retrieves WEM Registry Entries for a Configuration Set.
    .DESCRIPTION
        This function retrieves a list of all Registry Entries for a specified Configuration Set (Site).
    ...
    .PARAMETER SiteId
        The unique ID of the Configuration Set to retrieve Registry Entries from.
    .PARAMETER GetAssignmentCount
        When specified, includes the assignment count for each Registry Entry.
    .EXAMPLE
        PS C:\> # First, connect to the API
        PS C:\> Connect-WemApi -CustomerId "abcdef123" -UseSdkAuthentication

        PS C:\> # Retrieve all registry entries for site 7
        PS C:\> Get-WEMRegistryEntry -SiteId 7

    .EXAMPLE
        PS C:\> # Retrieve registry entries with assignment counts
        PS C:\> Get-WEMRegistryEntry -SiteId 7 -GetAssignmentCount
    .NOTES
        Version:        1.0
    ...
    try {
        ...
        $UriPath = "services/wem/action/registryEntry?siteId=$ResolvedSiteId"

        if ($GetAssignmentCount) {
        ...
        Write-Error "Failed to retrieve WEM Registry Entries: $($_.Exception.Message)"
        return $null
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDS2twr0NuB3hRZ
# ySv8ZW+mcOx/Dnmg/Ngmz3jDwTX1WKCCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IOZmFo8N+7WHdgvBJ/fU/YR4oL3CfjiWPJ5kVJvWGzEMMA0GCSqGSIb3DQEBAQUA
# BIIBgMzJYe7zBlXWqD5gK5GzjhE/pUPuDINBTKoSUnzS5VHTXmSExSRKEB88OMDE
# 0RRNBayT/w/cB8GRsJq64C3OOKqzBigi4VbyHwvYeuaEJ1eOTytbhIk7WdD95Z1+
# ydqh+UQfyrIXETg5qQgOFOZjQ/oL2Ff3FEaVtdKzdyK82Gx9XmamGRbeQ5F/trXd
# k0QohxHsecjjm3Qt88xXfixK/3PeqQiqhb6dRWcU57fT5acrHhxEgT8zYGqDcdTb
# 2e37dTQ/RYNqeb96CaM6J67wCKmVlBtT50e1szkWPewfjh3OJUfyrKZ0pI8IA6GE
# keW5BWBpZqHbrlAVksUvUWdT1K/tteDIqoN3x+M1edcRP++OrZbhB//9ml9hJ1Xa
# tUhV/kRXJXN53Tg2MpQGNCA07y79nPlF3bfZwgEhYVTHPSoQlegqgNJ9cA00Erz+
# Q4sur97haKe0hUzeK9BViKUadJB0wLrdT8rEwr8vko5S55uD303uB+kBQH08BzJ5
# /FM0zqGCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCCxKLcDiu9foZ2N
# dgmo6fuhFTWqjwAaqAtK/o9b3LlSaQIGacZiOPOWGBMyMDI2MDQxNTE5NTgzNC44
...
# AQkEMSIEIBgPkcz4mV0lauh0rs/G+Wz25pyh+GbHhEpyghZigLIKMIHdBgsqhkiG
...
# 71jXHZnzdbdaJdn9+I9RtQU3Kk+LLlkwDQYJKoZIhvcNAQELBQAEggIAwUfuNe5u
# vk+5ZJc+LEHvv34X+tj9aCdIhjcevlY+fWd495PZ8x5WHUGtxHmW8qeAtpvR17i/
# Q3X4ZirOsfSkuUjvCZ6JNWURjsUgtc2hBvF3Y3U0kTmSRVA3+j/VKzC/dOdkG8Gp
# flT+xN4/rlkjW/bn12QiAk393+A74undkBdsOFLWv1xP+ONx0slucL/RuEs7FmCh
# VqI2hZ6zKAa98XDtRpCZQtMH+NAqEhGK3S99o85c2sU6LXoa5qDVa6zgCkafBFCO
# EsKLGmgmmg3r9fLH8Kukd4Y5BYcm5xE9WfaIBGaju58wSCNfF4mrEHrWGq9bVUzV
# l3+DrQOUgGHFpH2eVFVTXKokb5/i26z3mHnTtCXjj3ZxrZ3uzNfr5I/K+WxhtPCu
# zCmn76xD7ad6T8xO8m312KrHHMat14gi4dg+skwblWkDQgXSYSH7KM774V6d1crg
# LOr8rGpytSGWZ+b7c5x+XkkVaJHeq8weSlAeeKK2tOCyXGaoJaL4fGr5RlAzqGNw
# oJDPnYCvT/GPmS+xGs4rdrDBzP71YQCBJ5e7N5gYE0cp/TTYw9jZtryyIE/pKHD3
# mI+kjzPCc/GoIFOZQyEzFiDUwA/CZtsCrKUlgVHcPC6gao3Benn7Oz6+rCZKONny
# kUNaPh+ZM59H0S/CkeBE1nT4WZR5dDzRWjw=
