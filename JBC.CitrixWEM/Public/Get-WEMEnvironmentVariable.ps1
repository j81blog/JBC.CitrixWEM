function Get-WEMEnvironmentVariable {
    <#
    .SYNOPSIS
        Retrieves environment variable actions from a WEM Configuration Set.
    .DESCRIPTION
        This function gets a list of all configured environment variable actions from a specified
        WEM Configuration Set (Site).
    .PARAMETER SiteId
        The ID of the WEM Configuration Set (Site) to query.
    .PARAMETER IncludeAssignmentCount
        If specified, the result will include the count of assignments for each environment variable.
    .EXAMPLE
        PS C:\> Get-WEMEnvironmentVariable -SiteId 1

        Retrieves all environment variable actions for the Configuration Set with ID 1.
    .NOTES
        Version:        1.0
    ...
    try {
        ...
        $UriPath = "services/wem/action/environmentVariable?siteId=$($ResolvedSiteId)"
        ...
        Write-Error "Failed to retrieve WEM Environment Variables for Site ID '$($ResolvedSiteId)': $($_.Exception.Message)"
        return $null
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBpEKdllhA4bUqg
# 1ZiHkmnmC9WmMhHOSXB4EmjCwAldKaCCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IFI5d28Q+v3qNn31Y3tc3pCqxueRcEVz88YU6IPb9T0IMA0GCSqGSIb3DQEBAQUA
# BIIBgLaxky5QdJ4RITlxYXagCkw9PilInuyUVehpnC62WROlnag/mmfUU33NS6XO
# veLlyr71ggTNQwFds8MvVpQz+iPgDC+89F2dlxYyXPF9q03allV1Z/nzxHKrYV+1
# cDhhDNHEqUx9aTNfVBn3Qk8ZfwgpBDH7FsJYjDufFh+p2fYPQzAIUCDLJQx3hDbu
# SQe9XsZA04aAVhKfXelqBgMGaGF7iXtQLzN0kewemHkqc8zpkZ263UUfrRwHOFC5
# kFjPhAtQVcKdSthf93v6m40LGJlub7R/rbXkDmjE2wFk129Wr9kJgXSIAML3pduW
# IwT05tm4uNVlcV6k/8ng/FB2cLYGA62GZeFv8VyW8UDw14uCICyq2SQaD6ATFqHd
# o36I6JiNzvsMwrMK456mcDiIazSZONilgy7Dtm+1n16ZVj9aBB/PxDDdj3VFTZZa
# wCAecI6s8epiQVxyTWWy9yI+nSeDJ08r0C91Cj4eBgy1SL1AZ/d4b2EuR2X/hRDZ
# GboHoKGCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCCYzv4ROcQ5yWhS
# hwDFCe1ZjKm1ERcGBEc9nHyGndKO1gIGacZcchqdGBMyMDI2MDQxNTE5NDU1OC4y
# ODRaMASAAgH0oIHppIHmMIHjMQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGlu
...
# AQkEMSIEIJudQIHFaAJWGZvrgJnlDH7yrQVJTiSLiLo0CATUzu1PMIHdBgsqhkiG
...
# IBH7Yg3Er3Da6Q80fPLQHn+iyLjKhfQwDQYJKoZIhvcNAQELBQAEggIAkaFSalkc
# y3DTLYKdGtueCrrbei4sI70p25sgrmnxmCwsiqpxJ348qMwlA0L/bYXzi8csRjXh
# gGKpqIoW16BFnN7uNYvimDKQjrML9KD3U70yNYuZjE4rMWFnD4yaQY3ebw9GE/rt
# FfyOw163cVN4RKRsiMJrPAHxeB7mCtU5cn9QddSl9aigGYgm9CwMqaqsFhlRM2GC
# dDsMo9emZ9TUzqIcfHn3buySl0VyIMoLpXvGgnUwKbo3UK/5hbu6redZqWqleLlI
# ZNnVJRvYcg3VKY/o+rtczsfS0lYSKWCj4z92sPR4UWYQ2EMUlSII6iLuWNAAconV
# oL1dt8881EUsuA1hO1gq9f55FyOPlQtsNX8QfvCNN3lKuyX2XG2GXkMlx9afc3Qr
# qtg73nz9hfR8m73DRrdEc9uHcu76mn86vxLrl9L6JI6pSGJvsOEaW8Kf8xXUGImg
# jFcKs0hp33MDWendStQsnC3O5DCSVnr2H1ovGxthQE0jVi1CXSNv46FJwyfg24LP
# 3xyR9FpVD80LkPSNQRGcsfgK2vI9CNuvO2/2pQof2UUuaZ5aA81Haj7x7sZgUf2k
# R1Rr6BIvlhpAUax+W//SLjc9l7Lx+3J/u+KFzUDWzJcoa2I484WXXJpqWkVTxbVF
# G0/fxJH69k1To7VUXka5arPry3qPubSB81o=
