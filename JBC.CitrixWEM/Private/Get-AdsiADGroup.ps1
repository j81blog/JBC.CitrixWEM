<#
    .SYNOPSIS
        This function retrieves an Active Directory group by name.

    .DESCRIPTION
        The Get-AdsiADGroup function retrieves an Active Directory group by name. It searches for the group in the domain of the current user and returns the group's name, sAMAccountName, and distinguishedName.

    .PARAMETER Identity
        Specifies the identity (Name) of the Active Directory group to retrieve.

    .PARAMETER SearchLimit
        Specifies the maximum number of search results to return. Default is 200.

    .PARAMETER SearchBase
        Specifies the search base for the group search. If not specified, the search will be performed in the domain of the current user.
    ...
    .EXAMPLE
        Get-AdsiADGroup -Identity "Administrators"
        This command retrieves the "Administrators" group from Active Directory.
...
function Get-AdsiADGroup {
    ...
    Write-Verbose "Starting function : Get-AdsiADGroup"
    ...
    if ($result.count -gt 0) {
        $result | ForEach-Object {
            $output = @{
                Name              = "$($_.OtherProperties.name)"
                sAMAccountName    = "$($_.OtherProperties.sAMAccountName)"
                DistinguishedName = "$($_.OtherProperties.distinguishedName)"
                ObjectSid         = "$($_.OtherProperties.objectSid)"
                Members           = @("$($_.OtherProperties.member)".Replace(' CN=', "|CN=").Split("|"))
            }
            Write-Output ([PSCustomObject]$output)
        }
    } else {
        if ($PSCmdlet.MyInvocation.BoundParameters.ContainsKey('Name')) {
            Write-Warning "Group with name '$Identity' not found in Active Directory."
        } else {
            Write-Warning "Group with LDAP filter '$LDAPFilter' not found in Active Directory."
        }
        Write-Output (@())
    }
    Write-Verbose "Ending function   : Get-AdsiADGroup"
}

# SIG # Begin signature block
# MII6BgYJKoZIhvcNAQcCoII59zCCOfMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCKbNopRnXYzVK8
# 3cQ31Yu3BGmZvHqWL08GHpl9eYG+YaCCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IH42MUcKpCfdu0/NA0TCUxKnwOplhSjWv79tLRhgCxLDMA0GCSqGSIb3DQEBAQUA
# BIIBgCoq9H/G0J3Fk7YuhNIahn5H6ysqCgVhlXXlOEpq8FoNC1MZmhyP1ESR2S+P
# IqtCZ+Aw0xDTzXEbq37PD7y0uuiD3Y6PTe2nQvhoE49/GEZ3XPYZUDiCmVAZtwpC
# GIjPyq+W9FllA/qIphfNRzZshp+VvUZumnyo+IQKuELe3AF+g9RIs5+oHEfktIrN
# +Ph229m9Xvpf0OyyX1rmBgx5YL+VFWICq1imwkdKyrhsi36kSvVRGfT2GHm4o9PP
# ZTUMym9J/13RafPJZe/9YwLPoP6iTo7zMW8ua7ZKWgzF91v6NHEf9ettd1NR7JId
# 2Pq6ylj4Ero3JLfKtfEMc5GpyVdkvl+VqJg+boDgAu0STIfewvkFoJ9DrWN03HP5
# 1EPvq55jid4gcmoSohzGmxM/rvh63K1kVC1drvgQ8TI427mYZ5K/6/peBsxWL+QC
# 3HL+62unTHsFN6FsqbVaIh6JkRNiv3eLFPfZKuxoWdLvlgx8VNG9/GMkG2IwJVai
# vZ5ATaGCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCCMiAznN3+WnI7y
# 9js3w92r9N6mTF2GXnTGr5fH8c2FaQIGacZuNOsWGBMyMDI2MDQxNTE5NDM1Ny4w
...
# AQkEMSIEIOJpKOP9VXQzBiLKa/rIh7TF8X/wQqi0Ue+NVs2SHULVMIHdBgsqhkiG
...
# 7uWUtl7jNMn9x8zfnOBTl8hH91XjZiAwDQYJKoZIhvcNAQELBQAEggIALBXXfD34
# MGU0paTcwWMSBOCzBQNjy5o2Blh3F6ZD8XXhI6UjLRYcrW/Xn3zGI+1Re0ABjgFv
# KCHLrjFx29+wXjq/eKIRpyt8KshSjdW5awWbFPquiGzCCoCbabhCXd8yn9+MWyY/
# U4H8WbGyQc/Q+0BR0QCzcgn1PkqnVU4T3S/5C/XiOY240tL0zQcojlsSjru0wiVy
# 3N7jVjML5uaHl/udTv05Gg6U7ZCQR04hgxSbK5YIsKhef/CtW0ySd1gNkl/wWm3y
# vJCrwbl1vfiXJuGcPpQ0npPDWt/VMxrF8zoo9Pc1sUy8k9BQqsF7e/v56bfmAfOu
# DH+3YHnMdcaB517TxQe/gfnUElKKVhmMIrBXA5KLiu5UCEhtfjSaTWOncrqtEUOZ
# +JkhR/4jd7rOYftjWvlfYyGV9SxLbAneTKgCNKr+TlJdnhLNtQaLuQgG7PbrhR/3
# pqHaH7NX1+rDj5z/txu5w9OFtzv+gaoOXENn7+yPtTjRYLJyKFXYdkSOp3nwmQz/
# UH45RHTCSZ9yUW4CcmHS749zauIX8qekfSalfiBiVue2oxQhwZkSbuapjlr+Xejz
# dh3s6nOgXbrTi6seIx956q0eMzbXQDtNV9tDcOdMbpqklqQlwlTkTKmN6IxaSFLl
# 0VYKFL2NyS2CVlZaFo49zYIPGR84GmfsN9A=
