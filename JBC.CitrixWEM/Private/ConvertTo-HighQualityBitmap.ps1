function ConvertTo-HighQualityBitmap {
    <#
    .SYNOPSIS
        Private helper function to convert an icon to a high-quality bitmap with transparency.

    .DESCRIPTION
        This internal function creates a high-quality bitmap from an icon with proper transparency
        preservation using 32bppArgb pixel format and high-quality rendering settings.

    .PARAMETER Icon
        The System.Drawing.Icon object to convert.

    .PARAMETER Size
        The desired width and height for the bitmap in pixels.

    .NOTES
        This is a private helper function used by Export-FileIcon.
        The caller is responsible for disposing of the returned Graphics and Bitmap objects.
    #>
    [CmdletBinding()]
    param (
    ...
    # Create high-quality bitmap with transparency support
    ...
    # Clear background to transparent and draw the icon with proper resizing
    $graphics.Clear([System.Drawing.Color]::Transparent)
    $rect = New-Object System.Drawing.Rectangle(0, 0, $Size, $Size)
    $graphics.DrawIcon($Icon, $rect)

    # Return both graphics and bitmap so caller can dispose of them properly
    return @{
        Graphics = $graphics
        Bitmap   = $bitmap
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCzGsoHW0XWQcME
# 08IuyBQZhZ7VrXK+pzo47cA+RbO5maCCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IDN6P55r4LZzcxumLMJRi0cq/161BR25o9I57GREg8/KMA0GCSqGSIb3DQEBAQUA
# BIIBgAAgfVteT4A/4MAxgIwB8upL9CO3R3wDPUCgqXA4x6+yZKP94FCkFJeawjTT
# KOzjyHYDcfQsxsLvXSVoVsemTE2bGXrdI0oQn7AouAamPGdBdOKwIOVsF5iFVFZP
# ZhPzuKxqHNn39cWWph7fP2F2gUicRoahIT0QeS0mZyDHKW3EMSQ0AM1M91IfUsze
# Cglp3o7xVKRcQoHzKG1ML2rfszac/GOhH9ObTdWpr1IrLfvIwtp5NAzse3Vva64O
# F8NbAdHZzkXws5C/d6a9zLhP1uXAnp7K9xtd0FqqRclFIesRACOxqIR0tuH9HuVi
# CFgsfJoU4bt6t5EqKiVVgFuo4X1r8ka38o9R/HY4humlKYCsaaFKXTHZdzB1OYNl
# TexPv3xmUIIaXkaEiNyNPV7woHI1y6/LvDfznBt7UfsCCYorvZJPZ+saWD4KNlEY
# i2nMcUojQRxh/GNhsuMb8kvyMVywCD1r55ljU5vRchaUxWwgAzqOFNNkLA7fUgey
# MMc6SaGCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCB3BbuujBmRvL6G
# Le9Gii7KAQRz+gbzhT2kEOy3HaulVgIGacZuNOsOGBMyMDI2MDQxNTE5NDMzNC41
# OTRaMASAAgH0oIHppIHmMIHjMQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGlu
...
# AQkEMSIEIN26JBVodIFohP+ukpiw9HfRr/R/N8uHuM4/PAYw/iSyMIHdBgsqhkiG
...
# 7uWUtl7jNMn9x8zfnOBTl8hH91XjZiAwDQYJKoZIhvcNAQELBQAEggIAiryf0uGS
# TWrVWH+2ejc0vuBVVNVcvOb2iogE5WVbP5OilfElFo77+ctBsOBnDxORzkgvJW72
# PXjSHOPKwPE2qwTidjmj8TG/qoEV8Yxr8EBAdbUnfpw73HaUiTPKQ73vkRENhY7c
# 7+YgnbXyJ4V6aARJL0efWKJAJL3Gpig9ETfw5pBvagwzJDcOyHEHF3+GB9L5UfLy
# ZJVf35ri6Q5diRZlJ8+8ZplM8/kDRa9NBcII3xepoEARwwScEuSJcPe62g7Hjk5u
# ctmyF1lty9/k9TTsElE2dnhEJnXg633iJFM2cTRpkbUT60kiXqBrOsvtFmP2BXPI
# kcYPxWeVm+GmVWTqAXutM1bBrNaC8Z+gOsDuetMX27FibEwxvftl/vfMsB/BGIwL
# iUXI/TiKHZBBfNg0r5SQsZsZG5geRsf6Aa0zeMojtLsI4Qv9KDzdyGmSGYTLTZqg
# FdhfrptHwK8uXkBJp7OiTZrzlOm1w4hGncHGLgYaI1FgyCbkh6SjPGhNuRhTHEuN
# ZdjgeRhklpfYB5H+hM3YTf02DF0T3E1E9aqPFL+PF0HPxrYvZ5jm6ZCZjhpjbF4I
# F98HZdjGcZyns2zlnh9m9W2qEssduVIbniQZQjIlhHaltanyV38XEKm4LAZ+c/bE
# qXha4TN/jQravtK/hsqDZ0rAhwZ/BuABrSA=
