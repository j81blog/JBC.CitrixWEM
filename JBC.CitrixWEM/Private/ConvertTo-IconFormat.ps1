function ConvertTo-IconFormat {
    <#
    .SYNOPSIS
        Private helper function to convert an icon to ICO format with size adjustment.

    .DESCRIPTION
        This internal function converts a System.Drawing.Icon to ICO format bytes with
        high-quality rendering and transparency preservation. It creates a new ICO file
        at the specified size using high-quality bitmap rendering.

    .PARAMETER Icon
        The System.Drawing.Icon object to convert.

    .PARAMETER Size
        The desired width and height for the icon in pixels.

    .PARAMETER AsBase64
        If specified, returns the ICO data as a Base64 string. Otherwise returns byte array.
    ...
    try {
        ...
        $bitmap.Dispose()
        $newIcon.Dispose()
        Remove-IconHandle -IconHandle $iconHandle
        ...
        throw "Failed to convert to ICO format: $($_.Exception.Message)"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB7qBHP5CUi3co5
# tSoR6RrRTCuMvN2W3UwfiitYcH20t6CCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IPl/4FEQ7Zi5ux1dzRK75UB6ELP0iwyxjj7G6K2apXHfMA0GCSqGSIb3DQEBAQUA
# BIIBgMpRIUU1nhh8xDu8bSqbje5zmLWm875DVQRZH19leI+G4YqgmcuseEou1L4Z
# 8b2AN7vTog83QqADqagR4IyZVxoLnbBb3jb7+/hKbR9dATSbPE4ixdvRdPgeVpV4
# ebChhB4nTfT27MPY6z/ad+1v1v7jYC4cefDDt+c92+afA6+kBhcSa1tNauQKYxP7
# DuYnwEPyJmvxwoi403g7mxydCp9sBSg4M5IeCAx83RcM1rBf+ko9ModM3UsUUfYt
# +BvgKz0PK7AvcVIrIuhPVVyJ43QStp446juWv6SDDaTpuStBNSv18/Bpa5HJafIs
# LxMirK8o7ICD14VU/3jBQFfnpU1EC4/8asLodm5lXMxJ/W07gdwTi/sQo/BQmC60
# Zq1mgUgOuWZz+GK5L4kECktesuM7tkjrAP7magZ6FOFqFTLlqovmViepKuBIIfXQ
# VjjHT4SwiHib+V5OJDOZRcnfj3Yv1vVGsDTMsFaxcJvwq7M71gEYpDY8Uuit88o2
# Ft7s+aGCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCCWuLlr3o7ikFyQ
# Yir7AyUwNLgVVJjl9p/OMzLyDTjD9gIGacZoEP/aGBMyMDI2MDQxNTE5NDMzNy4x
# NTVaMASAAgH0oIHppIHmMIHjMQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGlu
...
# AQkEMSIEIE1v6EK+oyG1EiPwYK1c5d0Baqgb2eAlE62Xv6lA1enmMIHdBgsqhkiG
...
# WkSPRedcsOuoQOHxTFAFxI2VSCznAIUwDQYJKoZIhvcNAQELBQAEggIAZPf+ZdOC
# EZ33rHIV7pBEAwh51Hd7Q8KBDqlbe3swGzKxT23oM1FwRjaSPTA4WUAMWjLPq58V
# 6v6O92TgoCvBh6WfEA1GLiBS0a8r8Dl5B/0lw0fPIZqp9q2jOD12Pk9KBMMcKEL2
# GzsmiGJ4o/clzCfeZHFPPRqvJOAQNNFElNq/7cwPvde5NBSAzupxGtv6mqH3rtHq
# GGQj8JKc28XHdf9gIDE0nuJH163M0hGlT1rdpVt3VAI9E/ZnvkwOzMuXweWhQvYP
# BmTz4S3vpHeI1pugr9oEzWJ8B5hicpJJwv4Cr5zPLGkV0GLWjpCt7Ze4y4VBvrx9
# 6XTpXIXGmYXMYtAGNPj+cZzGSzGDtFiVTMc15UQGsbQ7QY/MEgLV83Im9dPrOmsF
# +3JbMBcqIG3+Sd6EfjVMJm+S643JM1xPQPQterJWwDUMvb8vyFuyEFzFioBxFeIC
# dRofbGAC6PCnhFlWv95/s54sv0bSt0W+SvixoDygzzXZ2vr4r/aV1SHpfDS+pdmI
# FytlyR1wMFCscikxlr//6DvfEBf5bY6bVi9AaD3aRLKY0TPFjG0/tQH+4BKFC2S9
# Ct+u8LTXS6gVORGNEOFSCwz4uec19kSRlnBzFR5TV1+p0ZYgYgxjKFP9DdIm87GL
# keA+rXhhZh+VriaXGPM2SU4aR+dQyYYIdm8=
