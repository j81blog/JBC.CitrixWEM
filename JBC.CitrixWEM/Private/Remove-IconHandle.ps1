function Remove-IconHandle {
    <#
    .SYNOPSIS
        Private helper function to safely destroy an icon handle.

    .DESCRIPTION
        This internal function properly cleans up icon handles created by GetHicon() to prevent
        GDI resource leaks. It uses the Win32 DestroyIcon API.

    .PARAMETER IconHandle
        The IntPtr handle to the icon to destroy.

    .NOTES
        This is a private helper function used by Export-FileIcon.
        The IconHelper type is created only once using -ErrorAction SilentlyContinue.
    #>
    [CmdletBinding()]
    param (
    ...
    # Define the IconHelper class if not already defined
...
"@ -ErrorAction SilentlyContinue
    ...
    [void][IconHelper]::DestroyIcon($IconHandle)
}

# SIG # Begin signature block
# MII6BgYJKoZIhvcNAQcCoII59zCCOfMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBewFsbxsBFQ25i
# OgKLKK+TM0AA38TLYb9WbG/n2oluCaCCIiowggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# IBmKIxClhooS7Fia+9kUDJ8FO+PbHmkre9cboBBlHfDJMA0GCSqGSIb3DQEBAQUA
# BIIBgMJPO6hPox//juOLrlVL0N18fcOllnDj3+FzaQ6yLjpmfbmgAjr9eLekuMOG
# nWASZwxB73kcKmhVJjUNK1e6+pJId+zVkDNobnarXoRcLYzSqz0j4kApy3cVIj/E
# ihGQPwWpRezpaE59FzyNRkAyxNy8hkqGJ3IZw0oOVkCjgsFKq3OTe6h8Z9HgKYW2
# C+S1T5dpziQr8vPUp3uVG5EiziFxBKk5z/Y+zgd6sW794z9CjD3qCBJB0Fu6yYPc
# 4Y6OJqhpRLrzcNf5QjkZP3w15GiBmXgzPiCWuVK+BxmD73b44bBy2Lx2uqmBiWfJ
# mJvNr1h1xijARM67Ks+1Tvq8+haas32YWSkeMUoFwn7e+M6OA/0X02VPtKpjLRzt
# zx+IlCMuzGO+q+CrVLJtpKD8wUXYE46rxgfaIT096847vpe8mt9uPSCcuA4zIzM4
# 4Pudt5gUwPv+JwhNWKY5A2Cq9aZNv7u+joqyz2RK/5oEe4oxaoIGw6bi1ojR56Pw
# YRIqp6GCFLIwghSuBgorBgEEAYI3AwMBMYIUnjCCFJoGCSqGSIb3DQEHAqCCFIsw
# ghSHAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFqBgsqhkiG9w0BCRABBKCCAVkEggFV
# MIIBUQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCClDA9mNBwWp3es
# TeREa1EAokdoGTHsnhErHxl5OCTzSgIGacZuNOshGBMyMDI2MDQxNTE5NDQxOC4y
# MjFaMASAAgH0oIHppIHmMIHjMQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGlu
...
# AQkEMSIEIOrweGhj+W4YGd8UI1Pg0rTExY8SsH4WxYL6z46xW0BkMIHdBgsqhkiG
...
# 7uWUtl7jNMn9x8zfnOBTl8hH91XjZiAwDQYJKoZIhvcNAQELBQAEggIAftjBUxVu
# ToQBk1wOBpu0C3gUAd2RPOjvJEKBeRYsoaUlUH8xryDGA4FxBm7OlMDbrWtGKlbw
# tRVchVhNlW3ssY9dG+t45xaKCsZSb0Bz7Ih4x6MGJpLsBCkXsvGYohryYxAkkzF2
# a0pVt2rkqfEffKxPnk6AtTcZlGT9HpkBl6hAtZ8myWF6ywa3D3rpOPJk7VZMs3wi
# 8DJ6R9XrulqW1XOFDM2ZsS7Dx5ReTXrup8sip8MGIxMBNN9ZI/Y0a/gYdT7u9/RX
# I2qgcmOZF5TSStkUMX/klO2CXRuGTA7DClb21CxhdlV+G69yn5kuUWBmwtCO+Bs+
# exyDDlM0IrkYexIevWgk3PKoXTQdelt+aly4K02zZKeyFjDOn4JLfpUMWZf5DEU7
# eOW4H4toS4MeGbMweSYfU0QfYteIzgzCPpxKRKuugdX6tGmF02LoR70l28TeOfaM
# BHDDUOvDdjKGVI4RDk3XBGWNhZsnVn6RhGP8HaoofB2rnDpfowJj/7ZQrVtLSZw7
# ouwb1SMs/Ql5iIrIiW8Yl48oq2FCkN1f73V882IjX30+vAchROhODRrhbGEYObF5
# ZTqsbjUGIv9hUimzmWoFGV17yDVxo2roQmEcO3qk199b+invwBrJFBUIWvX0eqWF
# s5tCc7Ac/sBH1MPmP5+jS2vyiJtfRwFMaf4=
